...
object AutoTerminals : Module(
    ...
    val firstDelay by NumberSetting("First MouseButtonInfo Delay", 350, 200, 1000, 50, desc = "Delay in ms before the first click")
    val clickDelay by NumberSetting("MouseButtonInfo Delay", 190, 100, 500, desc = "Delay in ms between each click")
